...
<head>
	...
	<!-- Author Meta -->
	<meta name="author" content="Same Power Ministries">
	<!-- Meta Description -->
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Same Power Ministries</title>
...
<header id="header" id="home">
	<div class="container">
		<div class="row align-items-center justify-content-between d-flex">
			<div id="logo">
				<a href="./"><img src="img/logo.png" alt="" title="" style="max-height: 60px; " /></a> Same Power Ministries
			</div>
			<nav id="nav-menu-container">
				<ul class="nav-menu">
					<li class="menu-active"><a href="./">Home</a></li>
					<li><a href="about.html">About</a></li>
							<!-- <li><a href="#fact">Blog</a></li>
								<li><a href="#price">Events</a></li>
		...
		<div class="swiper-container slideshow">
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide slide">
					<div class="slide-image" style="background-image: url('img/churchbanner.jpg')"></div>
					<section class="banner-area" id="home" style="width: 100%;">
						<div class="container-fluid" style="background :#000000aa">
							<div class="row fullscreen d-flex align-items-center justify-content-start">
								<div class="banner-content col-lg-7">
									<h5 class="text-white text-uppercase">Worship With Us</h5>
									<h1 class="text-uppercase">
										<span class="slide-title">Same Power<br> Church</span>
									</h1>
									<p class="text-white pt-20 pb-20">
										Kentim University Complex, Kyanja
									</p>
									<!-- <a href="http://bit.ly/HolinessJohnEziel" class="primary-btn text-uppercase" target="_blank">Get Your Free Copy</a> -->
								</div>
				...
				<div class="swiper-slide slide">
					<div class="slide-image" style="background-image: url('img/sunsetlake.jpg');"></div>
					<section class="banner-area" id="home" style="width: 100%;">
						<div class="container-fluid" style="background :#000000aa">
							<div class="row fullscreen d-flex align-items-center justify-content-start">
								<div class="banner-content col-lg-7">
									<h5 class="text-white text-uppercase">John Enock Eziel</h5>
									<h1 class="text-uppercase">
										<span class="slide-title">Holiness</span>
									</h1>
									<p class="text-white pt-20 pb-20">
										God's Will For You
									</p>
									<a href="http://bit.ly/HolinessJohnEziel" class="primary-btn text-uppercase" target="_blank" style="background: white;">Get Your Free Copy</a>
								</div>
								<div class="col-lg-5 banner-right">
									<img class="img-fluid" src="img/header-img.png" alt="">
								</div>												
		...
		<div class="single-info row mt-40 align-items-center">
			...
			<div class="col-lg-6 col-md-12 no-padding info-rigth">
				<div class="info-content">
					<h2 class="pb-30">John Enock Eziel</h2>
					<p> John Enock Eziel is the founder and Head Pastor of Same Power Ministries, a Church in Kampala Uganda. He is also the founder of John Eziel Ministries. God called him in the Apostlic ministry, with a mandate to usher this generation into the Power and Works of the Holy Spirit.</p>
					<br>
					<p>
					...
					<div>
						...
						<a href="https://facebook.com/SamePowerChurch" class="icon-button facebook"><i class="icon-facebook"></i><span></span></a>
			...
			<div class="col-lg-2 col-md-6 col-sm-6 social-widget">
				<div class="single-footer-widget">
					...
					<div class="footer-social d-flex align-items-center">
						<a href="https://facebook.com/SamePowerChurch"><i class="fa fa-facebook"></i></a>
